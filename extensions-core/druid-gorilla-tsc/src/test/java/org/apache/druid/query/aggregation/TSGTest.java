...
public class TSGTest {
    ...
    public void test(){
        ...
        //TSG tmp = new TSG(100);
        //tmp.put(100,1.2);
        TSG tmp = TSG.fromBytes(StringUtils.decodeBase64String(""));
