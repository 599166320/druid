...
import org.apache.druid.guice.GorillaTscExtensionModule;
...
public class GorillaTscAggregatorTest extends InitializedNullHandlingTest
{
  ...
  public GorillaTscAggregatorTest(final GroupByQueryConfig config)
  {
    GorillaTscExtensionModule module = new GorillaTscExtensionModule();
  ...
  public void serializeDeserializeFactoryWithFieldName() throws Exception
  {
    ...
    new GorillaTscExtensionModule().getJacksonModules().forEach(objectMapper::registerModule);
    GorillaTscAggregatorFactory factory = new GorillaTscAggregatorFactory("name", "filedName", -1);
